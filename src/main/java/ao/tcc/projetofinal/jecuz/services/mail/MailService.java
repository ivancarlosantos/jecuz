...
public class MailService {
    ...
    public void sendVerificationEmail(Diarista diarista) throws MessagingException, UnsupportedEncodingException {

        DiaristaDTO dto = mapper.map(diarista, DiaristaDTO.class);

        String toAddress = dto.getEmail();
        String fromAddress = "eng.ivancarlos85@gmail.com";
        String senderName = "Jecuz Serviços de Terceirização";
        String subject = "Olá! "+dto.getNome()+", por Favor, valide seu registro";
        ...
        String content = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "                                  <span style=\"display:block;padding:14px 44px 13px;line-height:120%;\"><span style=\"font-size: 16px; line-height: 19.2px;\"><strong><span style=\"line-height: 19.2px; font-size: 16px;\">Pressione aqui para validar seu cadastro e e-mail</span></strong>\n" +
                "                                  </span>\n" +
                "                                  </span>\n" +
                "                                </a>\n" +
        ...
        content = content.replace("[[NAME]]", dto.getNome());

        String url = this.verifyURL + dto.getVerificationCode();
